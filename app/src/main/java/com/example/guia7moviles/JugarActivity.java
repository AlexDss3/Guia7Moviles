...
public class JugarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //SharedPreferences sharedp1= getPreferences(context.MODE_PRIVATE);
        ...
        if (NumGuardado == 0){
            ...
            editor.commit();
            Toast.makeText(JugarActivity.this,"No existe ningun valor guardado", Toast.LENGTH_SHORT).show();
        }else {
            ...
            public void onClick(View v) {
                if (txtNumUsuario.getText().length() != 0){
                    ...
                    if (NumAdivinar == NumUsuario){
                        Toast.makeText(JugarActivity.this,"Felicidades has adivinado", Toast.LENGTH_SHORT).show();
                    ...
                    {
                        Toast.makeText(JugarActivity.this,"Intentalo de nuevo", Toast.LENGTH_SHORT).show();
